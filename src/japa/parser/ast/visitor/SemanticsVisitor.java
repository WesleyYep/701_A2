...
public final class SemanticsVisitor implements VoidVisitor<Object> {
    ...
    public void visit(FieldDeclaration n, Object arg) {
        ...
        for (Iterator<VariableDeclarator> i = n.getVariables().iterator(); i.hasNext();) {
            ...
            if(typeOfRight == null){
            	return; //null on the right is allowed for fields
            }
    ...
    public String[] getBaseTypeAndGenerics(String type) {
    	...
    	if (matcher.matches()) {
    		System.out.println(type + " contains stuff!");
    ...
    public void visit(VariableDeclarationExpr n, Object arg) {
        ...
        for (Iterator<VariableDeclarator> i = n.getVars().iterator(); i.hasNext();) {
            ...
            if(typeOfRight == null){
            	return;
            	//throw new A2SemanticsException("Type of right is null - for " + v.getInit());
            }
            if(!isValidFor(typeOfRight, typeOfLeft)){
        		throw new A2SemanticsException("Cannot convert from " + typeOfRight.getName() + " to " + typeOfLeft.getName() + " on line " + n.getType().getBeginLine());
            }
